...
var Cu = (e2, t2) => () => (t2 || e2((t2 = { exports: {} }).exports, t2), t2.exports),
  dt$1 = (e2, t2) => {
    ...
    if ((t2 && typeof t2 == 'object') || typeof t2 == 'function')
      for (let u2 of du(t2))
        !Eu.call(e2, u2) &&
          ...
          pt$1(e2, u2, {
            get: () => t2[u2],
            enumerable: !(n3 = pu(t2, u2)) || n3.enumerable,
          })
    return e2
  }
var gu = (e2, t2, r2) => (
  (r2 = e2 != null ? Fu(mu(e2)) : {}),
  hu(pt$1(r2, 'default', { value: e2, enumerable: true }), e2)
)
var yu = (e2, t2, r2) => t2.has(e2) || er('Cannot ' + r2)
var tr = (e2, t2, r2) =>
  t2.has(e2)
    ? er('Cannot add the same private member more than once')
    : t2 instanceof WeakSet
      ? t2.add(e2)
      : t2.set(e2, r2)
...
var Pn = Cu((Mt2) => {
  ...
  function ho(e2, t2, r2) {
    let n3 = Object.assign({ column: 0, line: -1 }, e2.start),
      u2 = Object.assign({}, n3, e2.end),
      { linesAbove: o2 = 2, linesBelow: i = 3 } = r2 || {},
      s2 = n3.line,
      a2 = n3.column,
      c2 = u2.line,
      D2 = u2.column,
      p2 = Math.max(s2 - (o2 + 1), 0),
      l2 = Math.min(t2.length, c2 + i)
    ...
    if (F2)
      ...
      a2 === D2 ? (a2 ? (f3[s2] = [a2, 0]) : (f3[s2] = true)) : (f3[s2] = [a2, D2 - a2])
    return { start: p2, end: l2, markerLines: f3 }
  }
  function go(e2, t2, r2 = {}) {
    let u2 = Co(),
      o2 = e2.split(On),
      { start: i, end: s2, markerLines: a2 } = ho(t2, o2, r2),
      c2 = t2.start && typeof t2.start.column == 'number',
      D2 = String(s2).length,
      l2 = e2
        .split(On, s2)
        .slice(i, s2)
        .map((F2, f3) => {
          ...
          if (E2) {
            let x2 = ''
            if (Array.isArray(E2)) {
              let A2 = F2.slice(0, Math.max(E2[0] - 1, 0)).replace(/[^\t]/g, ' '),
                $2 = E2[1] || 1
              ;((x2 = [
                `
 `,
                u2.gutter(C2.replace(/\d/g, ' ')),
                ' ',
                A2,
                u2.marker('^').repeat($2),
              ].join('')),
                h2 && r2.message && (x2 += ' ' + u2.message(r2.message)))
            }
            return [
              u2.marker('>'),
              u2.gutter(C2),
...
var _e$1 = class _e {
  diff(t2, r2, n3 = {}) {
    ...
    typeof n3 == 'function'
      ? ((u2 = n3), (n3 = {}))
      : 'callback' in n3 && (u2 = n3.callback)
    let o2 = this.castInput(t2, n3),
      i = this.castInput(r2, n3),
      s2 = this.removeEmpty(this.tokenize(o2, n3)),
      a2 = this.removeEmpty(this.tokenize(i, n3))
  ...
  diffWithOptionsObj(t2, r2, n3, u2) {
    ...
    let p2 = (o2 = n3.timeout) !== null && o2 !== void 0 ? o2 : 1 / 0,
      l2 = Date.now() + p2,
      F2 = [{ oldPos: -1, lastComponent: void 0 }],
      f3 = this.extractCommon(F2[0], r2, t2, 0, n3)
    if (F2[0].oldPos + 1 >= a2 && f3 + 1 >= s2)
      return i(this.buildValues(F2[0].lastComponent, r2, t2))
    let d = -1 / 0,
      m3 = 1 / 0,
      C2 = () => {
        for (let E2 = Math.max(d, -c2); E2 <= Math.min(m3, c2); E2 += 2) {
          ...
          if (
            (!ue2 || ($2 && x2.oldPos < A2.oldPos)
              ? (h2 = this.addToPath(A2, true, false, 0, n3))
              : (h2 = this.addToPath(x2, false, true, 1, n3)),
            (f3 = this.extractCommon(h2, r2, t2, E2, n3)),
            h2.oldPos + 1 >= a2 && f3 + 1 >= s2)
          )
            return i(this.buildValues(h2.lastComponent, r2, t2)) || true
          ;((F2[E2] = h2),
            h2.oldPos + 1 >= a2 && (m3 = Math.min(m3, E2 - 1)),
            f3 + 1 >= s2 && (d = Math.max(d, E2 + 1)))
        }
        c2++
      }
    if (u2)
  ...
  addToPath(t2, r2, n3, u2, o2) {
    ...
    return i && !o2.oneChangePerToken && i.added === r2 && i.removed === n3
      ? {
          oldPos: t2.oldPos + u2,
          lastComponent: {
            count: i.count + 1,
      ...
      : {
          oldPos: t2.oldPos + u2,
          lastComponent: { count: 1, added: r2, removed: n3, previousComponent: i },
        }
  }
  extractCommon(t2, r2, n3, u2, o2) {
    let i = r2.length,
      ...
      c2 = a2 - u2,
      D2 = 0
    for (; c2 + 1 < i && a2 + 1 < s2 && this.equals(n3[a2 + 1], r2[c2 + 1], o2); )
      (c2++,
        a2++,
        D2++,
        o2.oneChangePerToken &&
          (t2.lastComponent = {
            count: 1,
            previousComponent: t2.lastComponent,
            added: false,
            removed: false,
          }))
    return (
  ...
  equals(t2, r2, n3) {
    return n3.comparator
      ? n3.comparator(t2, r2)
      : t2 === r2 || (!!n3.ignoreCase && t2.toLowerCase() === r2.toLowerCase())
  }
  removeEmpty(t2) {
    let r2 = []
  ...
  buildValues(t2, r2, n3) {
    let u2 = [],
      o2
    for (; t2; )
      (u2.push(t2), (o2 = t2.previousComponent), delete t2.previousComponent, (t2 = o2))
    u2.reverse()
    let i = u2.length,
      s2 = 0,
      a2 = 0,
    ...
    for (; s2 < i; s2++) {
      let D2 = u2[s2]
      if (D2.removed)
        ((D2.value = this.join(n3.slice(c2, c2 + D2.count))), (c2 += D2.count))
      else {
...
var W$1 = 'string',
  ...
  v$2 = 'indent-if-break',
  L$2 = 'line-suffix',
  I$1 = 'line-suffix-boundary',
  g$3 = 'line',
  S$3 = 'label',
  w$3 = 'break-parent',
  Ue$1 = /* @__PURE__ */ new Set([
    j$1,
    N$1,
    O$2,
    P$1,
...
var Bu = (e2, t2, r2) => {
    if (!(e2 && t2 == null))
      return Array.isArray(t2) || typeof t2 == 'string'
        ? t2[r2 < 0 ? t2.length + r2 : r2]
        : t2.at(r2)
  },
  y$2 = Bu
function or(e2) {
    ...
    if ((t2 == null ? void 0 : t2(o2)) !== false)
      switch (i) {
        ...
        case _$1:
          ...
          break
        case B$2:
          if (n3 && o2.expandedStates)
            for (let s2 = o2.expandedStates.length, a2 = s2 - 1; a2 >= 0; --a2)
              u2.push(o2.expandedStates[a2])
  ...
  function u2(o2) {
    switch (M$2(o2)) {
      ...
      case _$1:
        return t2({
          ...o2,
          breakContents: n3(o2.breakContents),
          flatContents: n3(o2.flatContents),
        })
      case B$2: {
        let { expandedStates: i, contents: s2 } = o2
        return (
          i ? ((i = i.map(n3)), (s2 = i[0])) : (s2 = n3(s2)),
          t2({ ...o2, contents: s2, expandedStates: i })
        )
      }
      case O$2:
      case N$1:
...
function ku(e2) {
  if ((e2.type === B$2 && e2.break) || (e2.type === g$3 && e2.hard) || e2.type === w$3)
    return true
}
function Dr(e2) {
...
function ar(e2) {
  for (
    e2 = [...e2];
    e2.length >= 2 && y$2(false, e2, -2).type === g$3 && y$2(false, e2, -1).type === w$3;
  )
    e2.length -= 2
  if (e2.length > 0) {
...
function we(e2) {
  switch (M$2(e2)) {
    ...
    case _$1:
      return {
        ...e2,
        breakContents: we(e2.breakContents),
        flatContents: we(e2.flatContents),
      }
    case k$2:
...
function Tu(e2) {
  switch (M$2(e2)) {
    ...
    case B$2:
      ...
      if (
        e2.contents.type === B$2 &&
        e2.contents.id === e2.id &&
        e2.contents.break === e2.break &&
        e2.contents.expandedStates === e2.expandedStates
      )
        return e2.contents
      break
    case O$2:
    ...
    case Y$1: {
      ...
      for (let r2 of e2) {
        ...
        ;(typeof n3 == 'string' && typeof y$2(false, t2, -1) == 'string'
          ? (t2[t2.length - 1] += n3)
          : t2.push(n3),
          t2.push(...u2))
      }
...
var Ar = { type: I$1 },
  pe$1 = { type: w$3 },
  Br = { type: P$1 },
  Te = { type: g$3, hard: true },
  Bt$1 = { type: g$3, hard: true, literal: true },
  Me = { type: g$3 },
  _r = { type: g$3, soft: true },
  z$1 = [Te, pe$1],
  We$1 = [Bt$1, pe$1],
  X$1 = { type: j$1 }
function ke(e2, t2) {
...
function Q$1(e2) {
  ...
  if (Array.isArray(e2)) {
    let r2 = []
    for (let n3 of e2)
      if (Array.isArray(n3)) r2.push(...Q$1(n3))
      else {
        let u2 = Q$1(n3)
        u2 !== '' && r2.push(u2)
      }
  ...
  return e2.type === _$1
    ? { ...e2, breakContents: Q$1(e2.breakContents), flatContents: Q$1(e2.flatContents) }
    : e2.type === B$2
      ? {
          ...e2,
          contents: Q$1(e2.contents),
          expandedStates: (t2 = e2.expandedStates) == null ? void 0 : t2.map(Q$1),
        }
      : e2.type === k$2
        ? { type: 'fill', parts: e2.parts.map(Q$1) }
        : e2.contents
          ? { ...e2, contents: Q$1(e2.contents) }
          : e2
}
function wr(e2) {
  ...
  function n3(o2, i, s2) {
    ...
    if (o2.type === w$3)
      return ((c2 = s2 == null ? void 0 : s2[i - 1]) == null ? void 0 : c2.type) ===
        g$3 && s2[i - 1].hard
        ? void 0
        : 'breakParent'
    ...
    if (o2.type === O$2)
      return o2.n === Number.NEGATIVE_INFINITY
        ? 'dedentToRoot(' + n3(o2.contents) + ')'
        : o2.n < 0
          ? 'dedent(' + n3(o2.contents) + ')'
          : o2.n.type === 'root'
            ? 'markAsRoot(' + n3(o2.contents) + ')'
            : 'align(' + JSON.stringify(o2.n) + ', ' + n3(o2.contents) + ')'
    if (o2.type === _$1)
      return (
        'ifBreak(' +
        n3(o2.breakContents) +
        (o2.flatContents ? ', ' + n3(o2.flatContents) : '') +
        (o2.groupId
          ? (o2.flatContents ? '' : ', ""') + `, { groupId: ${u2(o2.groupId)} }`
          : '') +
        ')'
      )
    if (o2.type === v$2) {
      let D2 = []
      ;(o2.negate && D2.push('negate: true'),
        o2.groupId && D2.push(`groupId: ${u2(o2.groupId)}`))
      let p2 = D2.length > 0 ? `, { ${D2.join(', ')} }` : ''
      return `indentIfBreak(${n3(o2.contents)}${p2})`
    }
    if (o2.type === B$2) {
      let D2 = []
      ;(o2.break && o2.break !== 'propagated' && D2.push('shouldBreak: true'),
        o2.id && D2.push(`id: ${u2(o2.id)}`))
      let p2 = D2.length > 0 ? `, { ${D2.join(', ')} }` : ''
      return o2.expandedStates
        ? `conditionalGroup([${o2.expandedStates.map((l2) => n3(l2)).join(',')}]${p2})`
        : `group(${n3(o2.contents)}${p2})`
    }
...
var Ne = vu
var R$2 = Symbol('MODE_BREAK'),
  H$2 = Symbol('MODE_FLAT'),
  de$1 = Symbol('cursor'),
  _t$1 = Symbol('DOC_FILL_PRINTED_LENGTH')
function Nr() {
...
function Iu(e2, t2, r2) {
  return t2 === Number.NEGATIVE_INFINITY
    ? e2.root || Nr()
    : t2 < 0
      ? xt$1(e2, { type: 'dedent' }, r2)
      : t2
        ? t2.type === 'root'
          ? { ...e2, root: e2 }
          : xt$1(
              e2,
              { type: typeof t2 == 'string' ? 'stringAlign' : 'numberAlign', n: t2 },
              r2,
            )
        : e2
}
function xt$1(e2, t2, r2) {
  let n3 = t2.type === 'dedent' ? e2.queue.slice(0, -1) : [...e2.queue, t2],
    u2 = '',
    o2 = 0,
    i = 0,
    s2 = 0
  ...
  for (; r2 >= 0; ) {
    ...
    switch (p2) {
      ...
      case B$2: {
        ...
        let l2 = D2.break ? R$2 : c2,
          F2 =
            D2.expandedStates && l2 === R$2
              ? y$2(false, D2.expandedStates, -1)
              : D2.contents
      ...
      case _$1: {
        let F2 =
          (D2.groupId ? u2[D2.groupId] || H$2 : c2) === R$2
            ? D2.breakContents
            : D2.flatContents
...
function me$1(e2, t2) {
  let r2 = {},
    n3 = t2.printWidth,
    u2 = xe$1(t2.endOfLine),
    o2 = 0,
    i = [{ ind: Nr(), mode: R$2, doc: e2 }],
    s2 = [],
    a2 = false,
    c2 = [],
    D2 = 0
...
`,
      ...
      case B$2:
        switch (F2) {
          ...
          case R$2: {
            a2 = false
            let d = { ind: l2, mode: H$2, doc: f3.contents },
              m3 = n3 - o2,
              C2 = c2.length > 0
            if (!f3.break && Ke$1(d, i, m3, C2, r2)) i.push(d)
              ...
              if (f3.break) {
                ...
                for (let h2 = 1; h2 < f3.expandedStates.length + 1; h2++)
                  if (h2 >= f3.expandedStates.length) {
                    i.push({ ind: l2, mode: R$2, doc: E2 })
                    break
                  } else {
                    let x2 = f3.expandedStates[h2],
                      A2 = { ind: l2, mode: H$2, doc: x2 }
      ...
      case k$2: {
        ...
        let h2 = C2[m3 + 0],
          x2 = C2[m3 + 1],
          A2 = { ind: l2, mode: H$2, doc: h2 },
          $2 = { ind: l2, mode: R$2, doc: h2 },
          ue2 = Ke$1(A2, [], d, c2.length > 0, r2, true)
        if (E2 === 1) {
          ue2 ? i.push(A2) : i.push($2)
          break
        }
        let Be = { ind: l2, mode: H$2, doc: x2 },
          lt2 = { ind: l2, mode: R$2, doc: x2 }
        if (E2 === 2) {
          ue2 ? i.push(Be, A2) : i.push(lt2, $2)
          break
        }
        let lu = C2[m3 + 2],
          Ft2 = { ind: l2, mode: F2, doc: { ...f3, [_t$1]: m3 + 2 } }
        Ke$1({ ind: l2, mode: H$2, doc: [h2, x2, lu] }, [], d, c2.length > 0, r2, true)
          ? i.push(Ft2, Be, A2)
          : ue2
            ? i.push(Ft2, lt2, A2)
            : i.push(Ft2, lt2, $2)
      ...
      case g$3:
        switch (F2) {
          ...
          case R$2:
            ...
            f3.literal
              ? l2.root
                ? (s2.push(u2, l2.root.value), (o2 = l2.root.length))
                : (s2.push(u2), (o2 = 0))
              : ((o2 -= wt$1(s2)), s2.push(u2 + l2.value), (o2 = l2.length))
            break
        }
        break
      case S$3:
  ...
  if (p2 !== -1) {
    ...
    let F2 = s2.slice(0, p2).join(''),
      f3 = s2.slice(p2 + 1, l2).join(''),
      d = s2.slice(l2 + 1).join('')
...
var Z$1,
  ...
  bt$1 = class bt {
    ...
    callParent(t2, r2 = 0) {
      let n3 = fe$1(this, Z$1, kt$1).call(this, r2 + 1),
        u2 = this.stack.splice(n3 + 1)
      try {
        return t2(this)
      } finally {
        this.stack.push(...u2)
    ...
    each(t2, ...r2) {
      ...
      try {
        for (let i = 0; i < o2.length; ++i)
          (n3.push(i, o2[i]), t2(this, i, o2), (n3.length -= 2))
      } finally {
        n3.length = u2
      }
    }
    ...
    match(...t2) {
      ...
      for (let o2 of t2) {
        ...
        if (
          (typeof n3 == 'number' &&
            ((i = n3), (n3 = this.stack[r2--]), (u2 = this.stack[r2--])),
          o2 && !o2(u2, n3, i))
        )
          return false
...
;((Z$1 = /* @__PURE__ */ new WeakSet()),
  (kt$1 = function (t2) {
    let { stack: r2 } = this
    for (let n3 = r2.length - 1; n3 >= 0; n3 -= 2)
      if (!Array.isArray(r2[n3]) && --t2 < 0) return n3
    return -1
  }),
  (ze$1 = function* () {
    let { stack: t2 } = this
...
var vr = Yu
function* Ce(e2, t2) {
  let { getVisitorKeys: r2, filter: n3 = () => true } = t2,
    u2 = (o2) => vr(o2) && n3(o2)
  for (let o2 of r2(e2)) {
    let i = e2[o2]
...
function Uu(e2, t2, r2 = {}) {
  let n3 = T$2(e2, r2.backwards ? t2 - 1 : t2, r2),
    u2 = U$1(e2, n3, r2)
  return n3 !== u2
}
var G$1 = Uu
...
var Yr = /* @__PURE__ */ new Set([
  ...
  $u = (e2) => Object.keys(e2).filter((t2) => !Yr.has(t2))
function Wu(e2) {
  return e2 ? (t2) => e2(t2, Yr) : $u
}
var J$1 = Wu
function Mu(e2) {
  let t2 = e2.type || e2.kind || '(unknown type)',
    r2 = String(
      e2.name ||
        (e2.id && (typeof e2.id == 'object' ? e2.id.name : e2.id)) ||
        (e2.key && (typeof e2.key == 'object' ? e2.key.name : e2.key)) ||
        (e2.value && (typeof e2.value == 'object' ? '' : String(e2.value))) ||
        e2.operator ||
        '',
    )
...
function St$1(e2, t2) {
  ;((e2.comments ?? (e2.comments = [])).push(t2),
    (t2.printed = false),
    (t2.nodeDescription = Mu(e2)))
}
function se$1(e2, t2) {
...
function Xe$1(e2, t2) {
  ...
  let {
    printer: { getCommentChildNodes: r2, canAttachComment: n3, getVisitorKeys: u2 },
    locStart: o2,
    locEnd: i,
  } = t2
  if (!n3) return []
  let s2 = (
    (r2 == null ? void 0 : r2(e2, t2)) ?? [...Ce(e2, { getVisitorKeys: J$1(u2) })]
  ).flatMap((a2) => (n3(a2) ? [a2] : Xe$1(a2, t2)))
  return (s2.sort((a2, c2) => o2(a2) - o2(c2) || i(a2) - i(c2)), Tt$1.set(e2, s2), s2)
}
function Ur(e2, t2, r2, n3) {
  let { locStart: u2, locEnd: o2 } = r2,
    i = u2(t2),
    s2 = o2(t2),
    a2 = Xe$1(e2, r2),
    c2,
  ...
  if ((n3 == null ? void 0 : n3.type) === 'TemplateLiteral') {
    let { quasis: F2 } = n3,
      f3 = Ot$1(F2, t2, r2)
    ;(c2 && Ot$1(F2, c2, r2) !== f3 && (c2 = null),
      D2 && Ot$1(F2, D2, r2) !== f3 && (D2 = null))
  }
...
function Vr(e2, t2) {
  ...
  let n3 = [],
    {
      printer: {
        experimentalFeatures: { avoidAstMutation: u2 = false } = {},
        handleComments: o2 = {},
      },
      originalText: i,
    } = t2,
    { ownLine: s2 = Nt$1, endOfLine: a2 = Nt$1, remaining: c2 = Nt$1 } = o2,
    D2 = r2.map((p2, l2) => ({
      ...Ur(e2, p2, t2),
      comment: p2,
      text: i,
  ...
  for (let [p2, l2] of D2.entries()) {
    ...
    if (
      ...
      ((F2.placement = 'ownLine'),
        s2(...A2) ||
          (m3 ? se$1(m3, F2) : f3 ? ae$1(f3, F2) : d ? ee$1(d, F2) : ee$1(h2, F2)))
    else if (Ku(C2, E2, D2, p2))
      ((F2.placement = 'endOfLine'),
        a2(...A2) ||
          (f3 ? ae$1(f3, F2) : m3 ? se$1(m3, F2) : d ? ee$1(d, F2) : ee$1(h2, F2)))
    else if (((F2.placement = 'remaining'), !c2(...A2)))
      if (f3 && m3) {
        let $2 = n3.length
...
function Gu(e2, t2, r2, n3) {
  let { comment: u2, precedingNode: o2 } = r2[n3],
    { locStart: i, locEnd: s2 } = t2,
    a2 = i(u2)
  if (o2)
    for (let c2 = n3 - 1; c2 >= 0; c2--) {
...
function Ku(e2, t2, r2, n3) {
  let { comment: u2, followingNode: o2 } = r2[n3],
    { locStart: i, locEnd: s2 } = t2,
    a2 = s2(u2)
  if (o2)
    for (let c2 = n3 + 1; c2 < r2.length; c2++) {
...
function jr(e2, t2) {
  ...
  let r2 = e2.length
  if (r2 === 0) return
  let { precedingNode: n3, followingNode: u2 } = e2[0],
    o2 = t2.locStart(u2),
    i
  for (i = r2; i > 0; --i) {
    ...
    if (
      ((a2 = (s2 = t2.printer).isGap) == null ? void 0 : a2.call(s2, l2, t2)) ??
      /^[\s(]*$/u.test(l2)
    )
      o2 = t2.locStart(c2)
    else break
  ...
  for (let c2 of [n3, u2])
    c2.comments &&
      c2.comments.length > 1 &&
      c2.comments.sort((D2, p2) => t2.locStart(D2) - t2.locStart(p2))
  e2.length = 0
}
...
function zu(e2, t2) {
  let r2 = t2 - 1
  ;((r2 = T$2(e2, r2, { backwards: true })),
    (r2 = U$1(e2, r2, { backwards: true })),
    (r2 = T$2(e2, r2, { backwards: true })))
...
function Hu(e2, t2) {
  ...
  let r2 = e2.node,
    n3 = [Wr(e2, t2)],
    { printer: u2, originalText: o2, locStart: i, locEnd: s2 } = t2
...
function Ju(e2, t2, r2) {
  ...
  let n3 = e2.node,
    u2 = Wr(e2, t2),
    { printer: o2, originalText: i, locStart: s2 } = t2,
    a2 = (c2 = o2.isBlockComment) == null ? void 0 : c2.call(o2, n3)
  if (
    (r2 != null && r2.hasLineSuffix && !(r2 != null && r2.isBlock)) ||
    G$1(i, s2(n3), { backwards: true })
  ) {
    let D2 = Pe(i, s2(n3))
    return { doc: Se([z$1, D2 ? z$1 : '', u2]), isBlock: a2, hasLineSuffix: true }
  }
  return !a2 || (r2 != null && r2.hasLineSuffix)
    ? { doc: [Se([' ', u2]), pe$1], isBlock: a2, hasLineSuffix: true }
    : { doc: [' ', u2], isBlock: a2, hasLineSuffix: false }
}
function qu(e2, t2) {
  let r2 = e2.node
  if (!r2) return {}
  let n3 = t2[Symbol.for('printedComments')]
  if ((r2.comments || []).filter((a2) => !n3.has(a2)).length === 0)
...
function Gr(e2) {
  ...
  for (let n3 of t2) {
    if (!n3.printed && !r2.has(n3))
      throw new Error(
        'Comment "' + n3.value.trim() + '" was not printed. Please report this error!',
      )
    delete n3.printed
  }
}
...
(mixed values within one file are normalised by looking at what's used after the first line)`,
  ...
  parser: {
    ...
    exception: (e2) => typeof e2 == 'string' || typeof e2 == 'function',
    choices: [
  ...
  plugins: {
    ...
    exception: (e2) => typeof e2 == 'string' || typeof e2 == 'object',
    cliName: 'plugin',
    cliCategory: 'Config',
  },
  printWidth: {
...
function Qe$1({ plugins: e2 = [], showDeprecated: t2 = false } = {}) {
  let r2 = e2.flatMap((u2) => u2.languages ?? []),
    n3 = []
  for (let u2 of Zu(Object.assign({}, ...e2.map(({ options: o2 }) => o2), zr)))
    (!t2 && u2.deprecated) ||
      (Array.isArray(u2.choices) &&
        (t2 || (u2.choices = u2.choices.filter((o2) => !o2.deprecated)),
        u2.name === 'parser' &&
          (u2.choices = [...u2.choices, ...Qu(u2.choices, r2, e2)])),
      (u2.pluginDefaults = Object.fromEntries(
        e2
          .filter((o2) => {
            var i
            return ((i = o2.defaultOptions) == null ? void 0 : i[u2.name]) !== void 0
          })
          .map((o2) => [o2.name, o2.defaultOptions[u2.name]]),
      )),
      n3.push(u2))
...
function* Qu(e2, t2, r2) {
  ...
  for (let u2 of t2)
    if (u2.parsers) {
      for (let o2 of u2.parsers)
        if (!n3.has(o2)) {
          n3.add(o2)
          let i = r2.find(
              (a2) => a2.parsers && Object.prototype.hasOwnProperty.call(a2.parsers, o2),
            ),
            s2 = u2.name
          ;(i != null && i.name && (s2 += ` (plugin: ${i.name})`),
            yield { value: o2, description: s2 })
        }
    }
}
function Zu(e2) {
  ...
  for (let [r2, n3] of Object.entries(e2)) {
    let u2 = { name: r2, ...n3 }
    ;(Array.isArray(u2.default) && (u2.default = y$2(false, u2.default, -1).value),
      t2.push(u2))
  }
  return t2
}
var eo = (e2, t2) => {
    if (!(e2 && t2 == null))
      return t2.toReversed || !Array.isArray(t2) ? t2.toReversed() : [...t2].reverse()
  },
  Hr = eo
var Jr,
  qr,
  ...
  to =
    ...
    false
function en(e2) {
  if (((e2 = e2 instanceof URL ? e2 : new URL(e2)), e2.protocol !== 'file:'))
    throw new TypeError(`URL must be a file URL: received "${e2.protocol}"`)
  return e2
}
function ro(e2) {
  return (
    (e2 = en(e2)),
    decodeURIComponent(e2.pathname.replace(/%(?![0-9A-Fa-f]{2})/g, '%25'))
  )
}
function no(e2) {
  e2 = en(e2)
  let t2 = decodeURIComponent(
    e2.pathname.replace(/\//g, '\\').replace(/%(?![0-9A-Fa-f]{2})/g, '%25'),
  ).replace(/^\\*([A-Za-z]:)(\\|$)/, '$1\\')
...
function nn(e2, t2) {
  ...
  return (
    e2.find(({ filenames: n3 }) =>
      n3 == null ? void 0 : n3.some((u2) => u2.toLowerCase() === r2),
    ) ??
    e2.find(({ extensions: n3 }) =>
      n3 == null ? void 0 : n3.some((u2) => r2.endsWith(u2)),
    )
  )
}
function oo(e2, t2) {
  if (t2)
    return (
      e2.find(({ name: r2 }) => r2.toLowerCase() === t2) ??
      e2.find(({ aliases: r2 }) => (r2 == null ? void 0 : r2.includes(t2))) ??
      e2.find(({ extensions: r2 }) => (r2 == null ? void 0 : r2.includes(`.${t2}`)))
    )
}
function un(e2, t2) {
  if (t2) {
    if (String(t2).startsWith('file:'))
      try {
        t2 = rn(t2)
      } catch {
        return
    ...
    if (typeof t2 == 'string')
      return e2.find(({ isSupported: r2 }) =>
        r2 == null ? void 0 : r2({ filepath: t2 }),
      )
  }
}
function io(e2, t2) {
  let r2 = Hr(false, e2.plugins).flatMap((u2) => u2.languages ?? []),
    n3 =
      oo(r2, t2.language) ??
      nn(r2, t2.physicalFile) ??
      nn(r2, t2.file) ??
      un(r2, t2.physicalFile) ??
      un(r2, t2.file) ??
      (t2.physicalFile, void 0)
...
var re$1 = {
  ...
  value(e2) {
    ...
    return t2.length === 0
      ? '{}'
      : `{ ${t2.map((r2) => `${re$1.key(r2)}: ${re$1.value(e2[r2])}`).join(', ')} }`
  },
...
var an = (e2, t2, { descriptor: r2 }) => {
  let n3 = [
    `${V$1.yellow(typeof e2 == 'string' ? r2.key(e2) : r2.pair(e2))} is deprecated`,
  ]
  return (
    t2 &&
      n3.push(
        `we now treat it as ${V$1.blue(typeof t2 == 'string' ? r2.key(t2) : r2.pair(t2))}`,
      ),
    n3.join('; ') + '.'
  )
}
var Ze$1 = Symbol.for('vnopts.VALUE_NOT_EXIST'),
  ge$1 = Symbol.for('vnopts.VALUE_UNCHANGED')
var Dn = ' '.repeat(2),
  fn = (e2, t2, r2) => {
    let { text: n3, list: u2 } = r2.normalizeExpectedResult(r2.schemas[e2].expected(r2)),
      o2 = []
    return (
      n3 && o2.push(cn(e2, t2, n3, r2.descriptor)),
      u2 &&
        o2.push(
          [cn(e2, t2, u2.title, r2.descriptor)].concat(
            u2.values.map((i) => ln(i, r2.loggerPrintWidth)),
          ).join(`
`),
        ),
...
function cn(e2, t2, r2, n3) {
  return [
    `Invalid ${V$1.red(n3.key(e2))} value.`,
    `Expected ${V$1.blue(r2)},`,
    `but received ${t2 === Ze$1 ? V$1.gray('nothing') : V$1.red(n3.value(t2))}.`,
  ].join(' ')
}
function ln({ text: e2, list: t2 }, r2) {
  let n3 = []
  return (
    e2 && n3.push(`- ${V$1.blue(e2)}`),
    t2 &&
      n3.push(
        [`- ${V$1.blue(t2.title)}:`].concat(
          t2.values.map((u2) => ln(u2, r2 - Dn.length).replace(/^|\n/g, `$&${Dn}`)),
        ).join(`
`),
      ),
    Fn(n3, r2)
...
function vt$1(e2, t2) {
  ...
  for (; p2 < u2; )
    for (i = t2.charCodeAt(o2 + p2), a2 = p2++, s2 = p2, D2 = 0; D2 < n3; D2++)
      ((c2 = i === pn[D2] ? a2 : a2 + 1),
        (a2 = Pt$1[D2]),
        (s2 = Pt$1[D2] = a2 > s2 ? (c2 > s2 ? s2 + 1 : c2) : c2 > a2 ? a2 + 1 : c2))
  return s2
}
var et$1 = (e2, t2, { descriptor: r2, logger: n3, schemas: u2 }) => {
  let o2 = [`Ignored unknown option ${V$1.yellow(r2.pair({ key: e2, value: t2 }))}.`],
    i = Object.keys(u2)
      .sort()
      .find((s2) => vt$1(e2, s2) < 3)
...
function Do(e2, t2, r2) {
  return typeof e2 == 'function'
    ? (...n3) => e2(...n3.slice(0, r2 - 1), t2, ...n3.slice(r2 - 1))
    : () => e2
}
...
var nt$1 = class nt extends b$2 {
  ...
  expected(t2) {
    let { text: r2, list: n3 } = t2.normalizeExpectedResult(
      this._valueSchema.expected(t2),
    )
    return {
      text: r2 && `an array of ${r2}`,
      list: n3 && { title: 'an array of the following values', values: [{ list: n3 }] },
    }
  }
  validate(t2, r2) {
...
function An(e2, t2) {
  ...
  let r2 = typeof e2,
    n3 = typeof t2,
    u2 = ['undefined', 'object', 'boolean', 'number', 'string']
  return r2 !== n3
    ? u2.indexOf(r2) - u2.indexOf(n3)
    : r2 !== 'string'
      ? Number(e2) - Number(t2)
      : e2.localeCompare(t2)
}
...
function It$1(e2) {
  ...
  return (
    ...
    r2
      ? { text: t2, list: { title: r2.title, values: r2.values.map(It$1) } }
      : { text: t2 }
  )
}
function Rt$1(e2, t2) {
...
function mn(e2, t2) {
  return typeof e2 == 'string' || 'key' in e2
    ? { from: t2, to: e2 }
    : 'from' in e2
      ? { from: e2.from, to: e2.to }
      : { from: t2, to: e2.to }
}
function ot$1(e2, t2) {
  return e2 === void 0
...
function jt$1(e2, t2) {
  ...
  return r2.length === 0
    ? { remain: t2, redirect: r2 }
    : typeof e2 == 'object' && 'remain' in e2
      ? { remain: e2.remain, redirect: r2 }
      : { redirect: r2 }
}
function co(e2, t2) {
...
var it$1 = class it extends b$2 {
  constructor(t2) {
    ;(super(t2),
      (this._choices = Cn(
        t2.choices.map((r2) => (r2 && typeof r2 == 'object' ? r2 : { value: r2 })),
        'value',
      )))
  }
  expected({ descriptor: t2 }) {
    let r2 = Array.from(this._choices.keys())
      ...
      u2 = r2.slice(-2)
    return {
      text: n3.concat(u2.join(' or ')).join(', '),
      list: { title: 'one of the following values', values: r2 },
    }
  }
  validate(t2) {
...
var Dt$1 = class Dt {
  constructor(t2, r2) {
    ...
    ;((this._utils = {
      ...
      loggerPrintWidth: u2,
      schemas: En(t2, 'name'),
      normalizeDefaultResult: Lt$1,
      normalizeExpectedResult: It$1,
      ...
      (this._invalidHandler = Bn(s2)),
      (this._deprecatedHandler = a2),
      (this._identifyMissing = (F2, f3) => !(F2 in f3) || c2(F2, f3)),
      (this._identifyRequired = D2),
      (this._preprocess = p2),
      (this._postprocess = l2),
      this.cleanHistory())
  }
  cleanHistory() {
  ...
  normalize(t2) {
    let r2 = {},
      u2 = [this._preprocess(t2, this._utils)],
      o2 = () => {
        for (; u2.length !== 0; ) {
          let i = u2.shift(),
            s2 = this._applyNormalization(i, r2)
          u2.push(...s2)
        }
      }
    o2()
    ...
    for (let i of Object.keys(this._utils.schemas)) {
      ...
      let s2 = this._utils.schemas[i],
        a2 = r2[i],
        c2 = s2.postprocess(a2, this._utils)
  ...
  _applyNormalization(t2, r2) {
    let n3 = [],
      { knownKeys: u2, unknownKeys: o2 } = this._partitionOptionKeys(t2)
    for (let i of u2) {
      let s2 = this._utils.schemas[i],
        a2 = s2.preprocess(t2[i], this._utils)
          ...
          if (d !== false)
            if (d === true)
              this._hasDeprecationWarned(i) ||
                this._utils.logger.warn(this._deprecatedHandler(i, f3, this._utils))
            else
              for (let { value: m3 } of d) {
  ...
  _applyRequiredCheck(t2) {
    for (let r2 of Object.keys(this._utils.schemas))
      if (this._identifyMissing(r2, t2) && this._identifyRequired(r2))
        throw this._invalidHandler(r2, Ze$1, this._utils)
  }
  _partitionOptionKeys(t2) {
    let [r2, n3] = gn(
      Object.keys(t2).filter((u2) => !this._identifyMissing(u2, t2)),
      (u2) => u2 in this._utils.schemas,
    )
...
function lo(
  ...
  let s2 = u2
      ? Array.isArray(u2)
        ? (l2, F2) => (u2.includes(l2) ? { [l2]: F2 } : void 0)
        : (l2, F2) => ({ [l2]: F2 })
      : (l2, F2, f3) => {
          let { _: d, ...m3 } = f3.schemas
          return et$1(l2, F2, { ...f3, schemas: m3 })
        },
    a2 = Fo(t2, { isCLI: n3, FlagSchema: o2 }),
    c2 = new Dt$1(a2, { logger: r2, unknown: s2, descriptor: i }),
    D2 = r2 !== false
...
function Fo(e2, { isCLI: t2, FlagSchema: r2 }) {
  ...
  for (let u2 of e2)
    (n3.push(po(u2, { isCLI: t2, optionInfos: e2, FlagSchema: r2 })),
      u2.alias && t2 && n3.push(tt$1.create({ name: u2.alias, sourceName: u2.name })))
  return n3
}
function po(e2, { isCLI: t2, optionInfos: r2, FlagSchema: n3 }) {
  ...
  switch (e2.type) {
    ...
    case 'choice':
      ;((i = it$1),
        (o2.choices = e2.choices.map((a2) =>
          a2 != null && a2.redirect
            ? { ...a2, redirect: { to: { key: e2.name, value: a2.redirect } } }
            : a2,
        )))
      break
    case 'boolean':
  ...
  if (
    (e2.exception
      ? (o2.validate = (a2, c2, D2) => e2.exception(a2) || c2.validate(a2, D2))
      : (o2.validate = (a2, c2, D2) => a2 === void 0 || c2.validate(a2, D2)),
    e2.redirect &&
      (s2.redirect = (a2) =>
        a2
          ? {
              to:
                typeof e2.redirect == 'string'
                  ? e2.redirect
                  : { key: e2.redirect.option, value: e2.redirect.value },
            }
          : void 0),
    e2.deprecated && (s2.deprecated = true),
    t2 && !e2.array)
  ) {
    let a2 = o2.preprocess || ((c2) => c2)
    o2.preprocess = (c2, D2, p2) =>
      D2.preprocess(a2(Array.isArray(c2) ? y$2(false, c2, -1) : c2), p2)
  }
  return e2.array
    ? nt$1.create({
        ...(t2 ? { preprocess: (a2) => (Array.isArray(a2) ? a2 : [a2]) } : {}),
        ...s2,
        valueSchema: i.create(o2),
      })
    : i.create({ ...o2, ...s2 })
}
var kn = lo
...
function $t$1(e2, t2) {
  ...
  let r2 = Vt$1(
    false,
    e2,
    (u2) => u2.parsers && Object.prototype.hasOwnProperty.call(u2.parsers, t2),
  )
  if (r2) return r2
  let n3 = `Couldn't resolve parser "${t2}".`
  throw (
    (n3 += ' Plugins must be explicitly added to the standalone bundle.'),
    new ve$1(n3)
  )
}
function Sn(e2, t2) {
  ...
  let r2 = Vt$1(
    false,
    e2,
    (u2) => u2.printers && Object.prototype.hasOwnProperty.call(u2.printers, t2),
  )
  if (r2) return r2
...
async function Eo(e2, t2 = {}) {
  ...
  if (!r2.parser)
    if (r2.filepath) {
      if (((r2.parser = on(r2, { physicalFile: r2.filepath })), !r2.parser))
        throw new Le(`No parser could be inferred for file "${r2.filepath}".`)
    } else throw new Le("No parser and no file path given, couldn't infer a parser.")
  let n3 = Qe$1({ plugins: e2.plugins, showDeprecated: true }).options,
    u2 = {
      ...Nn,
      ...Object.fromEntries(
        n3.filter((l2) => l2.default !== void 0).map((l2) => [l2.name, l2.default]),
      ),
    },
    o2 = $t$1(r2.plugins, r2.parser),
    i = await Wt$1(o2, r2.parser)
  ;((r2.astFormat = i.astFormat), (r2.locEnd = i.locEnd), (r2.locStart = i.locStart))
  let s2 =
      (p2 = o2.printers) != null && p2[i.astFormat] ? o2 : Sn(r2.plugins, i.astFormat),
    a2 = await Tn(s2, i.astFormat)
  r2.printer = a2
  let c2 = s2.defaultOptions
      ? Object.fromEntries(
          Object.entries(s2.defaultOptions).filter(([, l2]) => l2 !== void 0),
        )
      : {},
    D2 = { ...u2, ...c2 }
  for (let [l2, F2] of Object.entries(D2))
    (r2[l2] === null || r2[l2] === void 0) && (r2[l2] = F2)
  return (
    r2.parser === 'json' && (r2.trailingComma = 'none'),
    kn(r2, n3, { passThrough: Object.keys(Nn), ...t2 })
  )
}
var ne$1 = Eo
var vn = gu(Pn())
async function yo(e2, t2) {
  let r2 = await Re$1(t2),
    n3 = r2.preprocess ? r2.preprocess(e2, t2) : e2
  t2.originalText = n3
  let u2
  try {
...
async function Ln(e2, t2, r2, n3, u2) {
  let {
    embeddedLanguageFormatting: o2,
    printer: { embed: i, hasPrettierIgnore: s2 = () => false, getVisitorKeys: a2 },
  } = r2
  if (!i || o2 !== 'auto') return
  if (i.length > 2)
    throw new Error(
  ...
  let c2 = J$1(i.getVisitorKeys ?? a2),
    D2 = []
  F2()
  let p2 = e2.stack
  for (let { print: f3, node: d, pathStack: m3 } of D2)
    try {
      e2.stack = m3
...
function Rn(e2, t2, r2, n3, u2) {
  ...
  let { node: o2 } = e2,
    ...
    s2
  switch (
    ((a2 = i.hasPrettierIgnore) != null && a2.call(i, e2)
      ? (s2 = In(e2, t2))
      : u2.has(o2)
        ? (s2 = u2.get(o2))
        : (s2 = i.print(e2, t2, r2, n3)),
    o2)
  ) {
    case t2.cursorNode:
  ...
  return (
    i.printComment &&
      (!i.willPrintOwnComments || !i.willPrintOwnComments(e2, t2)) &&
      (s2 = Mr(e2, s2, t2)),
    s2
  )
}
async function Gt$1(e2, t2) {
  let r2 = e2.comments ?? []
  ;((t2[Symbol.for('comments')] = r2),
    (t2[Symbol.for('printedComments')] = /* @__PURE__ */ new Set()),
    Vr(e2, t2))
  let {
    printer: { preprocess: n3 },
  } = t2
  return ((e2 = n3 ? await n3(e2, t2) : e2), { ast: e2, comments: r2 })
}
function xo(e2, t2) {
  let { cursorOffset: r2, locStart: n3, locEnd: u2 } = t2,
    o2 = J$1(t2.printer.getVisitorKeys),
    i = (F2) => n3(F2) <= r2 && u2(F2) >= r2,
    s2 = e2,
    a2 = [e2]
...
function wo(e2, t2) {
  let {
    printer: { massageAstNode: r2, getVisitorKeys: n3 },
  } = t2
  if (!r2) return e2
  let u2 = J$1(n3),
    o2 = r2.ignoredProperties ?? /* @__PURE__ */ new Set()
  return i(e2)
  function i(s2, a2) {
    ...
    let c2 = {},
      D2 = new Set(u2(s2))
    for (let l2 in s2)
      !Object.prototype.hasOwnProperty.call(s2, l2) ||
        o2.has(l2) ||
        (D2.has(l2) ? (c2[l2] = i(s2[l2], s2)) : (c2[l2] = s2[l2]))
    let p2 = r2(s2, c2, a2)
...
var bo = (e2, t2, r2) => {
  ...
  jn = bo
var ko = ({ parser: e2 }) =>
  e2 === 'json' || e2 === 'json5' || e2 === 'jsonc' || e2 === 'json-stringify'
function So(e2, t2) {
  let r2 = [e2.node, ...e2.parentNodes],
    n3 = /* @__PURE__ */ new Set([t2.node, ...t2.parentNodes])
...
function To(e2, t2, { locStart: r2, locEnd: n3 }) {
  ...
  let i = r2(e2.node)
  for (let a2 of Un(t2.parentNodes))
    if (r2(a2) >= i) o2 = a2
    else break
  let s2 = n3(t2.node)
...
function No(e2, t2) {
  return (
    t2 !== 'DeclareExportDeclaration' &&
    e2 !== 'TypeParameterDeclaration' &&
    (e2 === 'Directive' ||
      e2 === 'TypeAlias' ||
      e2 === 'TSExportAssignment' ||
      e2.startsWith('Declare') ||
      e2.startsWith('TSDeclare') ||
      e2.endsWith('Statement') ||
      e2.endsWith('Declaration'))
  )
}
...
function Wn(e2, t2, r2) {
  ...
  Oe.ok(u2 > n3)
  let s2 = e2.slice(n3, u2).search(/\S/u),
    a2 = s2 === -1
  if (!a2) for (n3 += s2; u2 > n3 && !/\S/u.test(e2[u2 - 1]); --u2);
  let c2 = zt$1(r2, n3, t2, (F2, f3) => Vn(t2, F2, f3), [], 'rangeStart'),
    D2 = a2 ? c2 : zt$1(r2, u2, t2, (F2) => Vn(t2, F2), [], 'rangeEnd')
...
async function Hn(e2, t2, r2 = 0) {
  ...
  if (r2 > 0) {
    ...
    ;(i.cursorNodeStart !== void 0 &&
      ((i.cursorNodeStart -= i.formatted.indexOf(a2)),
      i.cursorNodeStart < 0 &&
        ((i.cursorNodeStart = 0), (i.cursorNodeText = i.cursorNodeText.trimStart())),
      i.cursorNodeStart + i.cursorNodeText.length > a2.length &&
        (i.cursorNodeText = i.cursorNodeText.trimEnd())),
      (i.formatted = a2 + xe$1(t2.endOfLine)))
  }
  let s2 = t2[Symbol.for('comments')]
  if (t2.cursorOffset >= 0) {
    let a2, c2, D2, p2
    if ((t2.cursorNode || t2.nodeBeforeCursor || t2.nodeAfterCursor) && i.cursorNodeText)
      if (((D2 = i.cursorNodeStart), (p2 = i.cursorNodeText), t2.cursorNode))
        ((a2 = t2.locStart(t2.cursorNode)), (c2 = u2.slice(a2, t2.locEnd(t2.cursorNode))))
      else {
...
async function Po(e2, t2) {
  let { ast: r2, text: n3 } = await De$1(e2, t2),
    { rangeStart: u2, rangeEnd: o2 } = Wn(n3, t2, r2),
    i = n3.slice(u2, o2),
    s2 = Math.min(
      u2,
      n3.lastIndexOf(
...
`,
    ...
    a2 = n3.slice(s2, u2).match(/^\s*/u)[0],
    c2 = Ee$1(a2, t2.tabWidth),
    D2 = await Hn(
      i,
      {
        ...t2,
        ...
        cursorOffset:
          t2.cursorOffset > u2 && t2.cursorOffset <= o2 ? t2.cursorOffset - u2 : -1,
        endOfLine: 'lf',
      },
      c2,
    ),
    p2 = D2.formatted.trimEnd(),
    { cursorOffset: l2 } = t2
  l2 > o2
    ? (l2 += p2.length - i.length)
    : D2.cursorOffset >= 0 && (l2 = D2.cursorOffset + u2)
...
function Gn(e2, t2) {
  ...
  return (
    (r2 = Ht$1(e2, r2, -1)),
    (n3 = Ht$1(e2, n3, 0)),
    (u2 = Ht$1(e2, u2, e2.length)),
    { ...t2, cursorOffset: r2, rangeStart: n3, rangeEnd: u2 }
  )
}
function Jn(e2, t2) {
  let { cursorOffset: r2, rangeStart: n3, rangeEnd: u2, endOfLine: o2 } = Gn(e2, t2),
    i = e2.charAt(0) === zn
  if (
    (i && ((e2 = e2.slice(1)), r2--, n3--, u2--),
    o2 === 'auto' && (o2 = nr(e2)),
    e2.includes('\r'))
  ) {
    let s2 = (a2) =>
      Ct$1(
        e2.slice(0, Math.max(a2, 0)),
        `\r
`,
      )
...
async function Jt$1(e2, t2) {
  ...
  if (
    (u2.rangeStart >= u2.rangeEnd && n3 !== '') ||
    (u2.requirePragma && !(await Kn(n3, u2))) ||
    (u2.checkIgnorePragma && (await vo(n3, u2)))
  )
    return { formatted: e2, cursorOffset: t2.cursorOffset, comments: [] }
  let o2
  return (
    u2.rangeStart > 0 || u2.rangeEnd < n3.length
      ? (o2 = await Po(n3, u2))
      : (!u2.requirePragma &&
          u2.insertPragma &&
          u2.printer.insertPragma &&
          !(await Kn(n3, u2)) &&
          (n3 = u2.printer.insertPragma(n3)),
        (o2 = await Hn(n3, u2))),
    r2 && ((o2.formatted = zn + o2.formatted), o2.cursorOffset >= 0 && o2.cursorOffset++),
    o2
  )
}
async function qn(e2, t2, r2) {
  let { text: n3, options: u2 } = Jn(e2, await ne$1(t2)),
    o2 = await De$1(n3, u2)
  return (
    r2 &&
      (r2.preprocessForPrint && (o2.ast = await Gt$1(o2.ast, u2)),
      r2.massage && (o2.ast = Yn(o2.ast, u2))),
    o2
  )
}
...
async function Qn(e2, t2) {
  let r2 = wr(e2),
    { formatted: n3 } = await Jt$1(r2, { ...t2, parser: '__js_expression' })
  return n3
}
...
dt$1(Qt$1, {
  ...
  addLeadingComment: () => se$1,
  addTrailingComment: () => ae$1,
...
function jo(e2, t2) {
  ...
  if (e2.charAt(t2) === '/' && e2.charAt(t2 + 1) === '*') {
    for (let r2 = t2 + 2; r2 < e2.length; ++r2)
      if (e2.charAt(r2) === '*' && e2.charAt(r2 + 1) === '/') return r2 + 2
  }
  return t2
}
var ye$1 = jo
...
function $o(e2, t2) {
  let r2 = null,
    n3 = t2
  for (; n3 !== r2; )
    ((r2 = n3), (n3 = He$1(e2, n3)), (n3 = ye$1(e2, n3)), (n3 = T$2(e2, n3)))
...
var ft$1 = "'",
  ou = '"'
function Ko(e2, t2) {
  let r2 = t2 === true || t2 === ft$1 ? ft$1 : ou,
    n3 = r2 === ft$1 ? ou : ft$1,
    u2 = 0,
    o2 = 0
...
function ce$1(e2, t2 = 1) {
  return async (...r2) => {
    let n3 = r2[t2] ?? {},
      u2 = n3.plugins ?? []
    return (
      (r2[t2] = { ...n3, plugins: Array.isArray(u2) ? u2 : Object.values(u2) }),
      e2(...r2)
    )
  }
}
...
const STYLE_TO_LOCALES_MAP = {
  ...
  ['germanQuotes']:
    /* GermanQuotes */
    ['de', 'ka', 'cs', 'et', 'is', 'lt', 'mk', 'ro', 'sk', 'sl', 'wen'],
  ['finnishQuotes']:
    /* FinnishQuotes */
    ['fi', 'sv', 'bs'],
}
  ...
  ;(function (module, exports$1) {
    ;(function (root) {
      ...
      var invalidReferenceCodePoints = [
        ...
        64994, 64995, 64996, 64997, 64998, 64999, 65e3, 65001, 65002, 65003, 65004, 65005,
        65006, 65007, 65534, 65535, 131070, 131071, 196606, 196607, 262142, 262143,
        327678, 327679, 393214, 393215, 458750, 458751, 524286, 524287, 589822, 589823,
        655358, 655359, 720894, 720895, 786430, 786431, 851966, 851967, 917502, 917503,
  ...
  try {
    if (typeof globalThis.document < 'u') {
      ...
      ;(e2.appendChild(
        ...
        globalThis.document.head.appendChild(e2))
    }
  } catch (a2) {
...
let n$1 = class n {
  ...
  constructor({ data: t2, config: e2, api: i, readOnly: s2 }) {
    ;((this.api = i),
      ...
      (this._placeholder = e2.placeholder ? e2.placeholder : n.DEFAULT_PLACEHOLDER),
      (this._data = t2 ?? {}),
      (this._element = null),
      (this._preserveBlank = e2.preserveBlank ?? false))
  }
  /**
   ...
   */
  onKeyUp(t2) {
    if ((t2.code !== 'Backspace' && t2.code !== 'Delete') || !this._element) return
  ...
  drawView() {
    const t2 = globalThis.document.createElement('DIV')
    return (
      t2.classList.add(this._CSS.wrapper, this._CSS.block),
      (t2.contentEditable = 'false'),
      (t2.dataset.placeholderActive = this.api.i18n.t(this._placeholder)),
      this._data.text && (t2.innerHTML = this._data.text),
      this.readOnly ||
        ((t2.contentEditable = 'true'), t2.addEventListener('keyup', this.onKeyUp)),
      t2
    )
  }
  /**
...
function p$1(d, e2 = null, t2) {
  ...
  for (const n3 in t2) r2[n3] = t2[n3]
  return r2
}
function g$2(d) {
  const e2 = p$1('div')
...
function C$2(d) {
  ...
  return (
    d.nodeType !== Node.ELEMENT_NODE
      ? (e2 = d.textContent)
      : ((e2 = d.innerHTML), (e2 = e2.replaceAll('<br>', ''))),
    (e2 == null ? void 0 : e2.trim().length) === 0
  )
}
class u {
  /**
  ...
  restore() {
    ...
    if (!e2) return
    const t2 = new Range()
    ;(t2.setStartAfter(this.savedFakeCaret),
      t2.setEndAfter(this.savedFakeCaret),
      e2.removeAllRanges(),
      e2.addRange(t2),
      setTimeout(() => {
        var r2
  ...
  static extractFragmentFromCaretPositionTillTheEnd() {
    ...
    return (
      s2.selectNodeContents(n3),
      s2.setStart(t2.endContainer, t2.endOffset),
      s2.extractContents()
    )
  }
  /**
  ...
  static focus(e2, t2 = true) {
    const r2 = globalThis.document.createRange(),
      n3 = globalThis.window.getSelection()
    n3 &&
      (r2.selectNodeContents(e2), r2.collapse(t2), n3.removeAllRanges(), n3.addRange(r2))
  }
  /**
  ...
  static isAtStart() {
    const e2 = globalThis.window.getSelection()
    if (!e2 || e2.focusOffset > 0) return false
    const t2 = e2.focusNode
    return !t2 || !c$2(t2)
      ? false
      : u.getHigherLevelSiblings(t2, 'left').every((s2) => C$2(s2))
  }
  /**
  ...
  static getHigherLevelSiblings(e2, t2 = 'left') {
    let r2 = e2
    const n3 = []
    for (; r2.parentNode && r2.parentNode.contentEditable !== 'true'; ) r2 = r2.parentNode
    const s2 = t2 === 'left' ? 'previousSibling' : 'nextSibling'
    for (; r2[s2]; ) ((r2 = r2[s2]), n3.push(r2))
    return n3
  }
}
const w$2 =
...
let f$1 = class f {
  ...
  constructor({ data: e2, config: t2, api: r2, readOnly: n3 }) {
    ...
    ;((this.nodes = {
      ...
      (this.defaultListStyle =
        ((i = this.config) == null ? void 0 : i.defaultStyle) === 'ordered'
          ? 'ordered'
          : 'unordered'))
    const s2 = {
  ...
  pasteHandler(e2) {
    ...
    const s2 = {
      ...
      i = (l2) =>
        Array.from(l2.querySelectorAll(':scope > li')).map((o2) => {
          var m3
          const a2 = o2.querySelector(`:scope > ${n3}`),
            y2 = a2 ? i(a2) : []
          return {
            content:
              ((m3 = o2 == null ? void 0 : o2.firstChild) == null
                ? void 0
                : m3.textContent) || '',
            items: y2,
          }
   ...
   */
  createItem(e2, t2 = []) {
    const r2 = p$1('li', this.CSS.item),
      n3 = p$1('div', this.CSS.itemBody),
      s2 = p$1('div', this.CSS.itemContent, {
        innerHTML: e2,
    ...
    return (
      n3.appendChild(s2),
      r2.appendChild(n3),
      t2 && t2.length > 0 && this.addChildrenList(r2, t2),
      r2
    )
  }
  /**
  ...
  save() {
    const e2 = (t2) =>
      Array.from(t2.querySelectorAll(`:scope > .${this.CSS.item}`)).map((n3) => {
        const s2 = n3.querySelector(`.${this.CSS.itemChildren}`),
          i = this.getItemContent(n3),
          l2 = s2 ? e2(s2) : []
        return {
          content: i,
          items: l2,
  ...
  addChildrenList(e2, t2) {
    const r2 = e2.querySelector(`.${this.CSS.itemBody}`),
      n3 = this.makeListWrapper(void 0, [this.CSS.itemChildren])
  ...
  makeListWrapper(e2 = this.listStyle, t2 = []) {
    const r2 = e2 === 'ordered' ? 'ol' : 'ul',
      n3 = e2 === 'ordered' ? this.CSS.wrapperOrdered : this.CSS.wrapperUnordered
   ...
   */
  set listStyle(e2) {
    if (!this.nodes || !this.nodes.wrapper) return
    const t2 = Array.from(this.nodes.wrapper.querySelectorAll(`.${this.CSS.wrapper}`))
    ;(t2.push(this.nodes.wrapper),
      t2.forEach((r2) => {
        ;(r2.classList.toggle(this.CSS.wrapperUnordered, e2 === 'unordered'),
          r2.classList.toggle(this.CSS.wrapperOrdered, e2 === 'ordered'))
      }),
      (this.data.style = e2))
  }
  /**
  ...
  get currentItem() {
    ...
    return !t2 || (c$2(t2) || (t2 = t2.parentNode), !t2) || !c$2(t2)
      ? null
      : t2.closest(`.${this.CSS.item}`)
  }
  /**
  ...
  enterPressed(e2) {
    ...
    if ((e2.stopPropagation(), e2.preventDefault(), e2.isComposing)) return
    const r2 = t2 ? this.getItemContent(t2).trim().length === 0 : true,
      n3 = (t2 == null ? void 0 : t2.parentNode) === this.nodes.wrapper,
      s2 = (t2 == null ? void 0 : t2.nextElementSibling) === null
    if (n3 && s2 && r2) {
      this.getOutOfList()
      return
    } else if (s2 && r2) {
    ...
    if (!i) return
    const l2 = g$2(i),
      h2 = t2 == null ? void 0 : t2.querySelector(`.${this.CSS.itemChildren}`),
      o2 = this.createItem(l2, void 0)
    ;(h2 && Array.from(h2.querySelectorAll(`.${this.CSS.item}`)).length > 0
      ? h2.prepend(o2)
      : t2 == null || t2.after(o2),
      this.focusItem(o2))
  }
  ...
  unshiftItem() {
    ...
    if (!e2 || !e2.parentNode || !c$2(e2.parentNode)) return
    const t2 = e2.parentNode.closest(`.${this.CSS.item}`)
    if (!t2) return
    ;(this.caret.save(), t2.after(e2), this.caret.restore())
    const r2 = t2.querySelector(`.${this.CSS.itemChildren}`)
    if (!r2) return
  ...
  focusItem(e2, t2 = true) {
    const r2 = e2.querySelector(`.${this.CSS.itemContent}`)
    r2 && u.focus(r2, t2)
  }
  /**
  ...
  getOutOfList() {
    var e2
    ;((e2 = this.currentItem) == null || e2.remove(),
   ...
   */
  backspace(e2) {
    if (!u.isAtStart()) return
    e2.preventDefault()
    const t2 = this.currentItem
    if (!t2) return
    const r2 = t2.previousSibling
    if (!t2.parentNode || !c$2(t2.parentNode)) return
    const n3 = t2.parentNode.closest(`.${this.CSS.item}`)
    if ((!r2 && !n3) || (r2 && !c$2(r2))) return
    e2.stopPropagation()
    let s2
    if (r2) {
      const a2 = r2.querySelectorAll(`.${this.CSS.item}`)
    ...
    const l2 = g$2(i)
    if (!s2) return
    const h2 = s2.querySelector(`.${this.CSS.itemContent}`)
    if (!h2) return
    ;(u.focus(h2, false), this.caret.save(), h2.insertAdjacentHTML('beforeend', l2))
    let o2 = t2.querySelectorAll(`.${this.CSS.itemChildren} > .${this.CSS.item}`)
    ;((o2 = Array.from(o2)),
      (o2 = o2.filter((a2) =>
        !a2.parentNode || !c$2(a2.parentNode)
          ? false
          : a2.parentNode.closest(`.${this.CSS.item}`) === t2,
      )),
      o2.reverse().forEach((a2) => {
  ...
  addTab(e2) {
    ...
    if (!t2) return
    const r2 = t2.previousSibling
    if (!r2 || !c$2(r2) || !r2) return
    const s2 = r2.querySelector(`.${this.CSS.itemChildren}`)
    if ((this.caret.save(), s2)) s2.appendChild(t2)
    else {
      const i = this.makeListWrapper(void 0, [this.CSS.itemChildren]),
...
`
  ...
  static importFromMarkdown(editor, markdown) {
    ...
    const rootItems = []
    const stack = [{ items: rootItems, depth: -1 }]
  ...
  try {
    if (typeof globalThis.document < 'u') {
      ...
      ;(t2.appendChild(
        ...
        globalThis.document.head.appendChild(t2))
    }
  } catch (e2) {
  ...
  if (typeof t2 == 'function') {
    var n3 = function r2() {
      return this instanceof r2
        ? Reflect.construct(t2, arguments, this.constructor)
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.allInputsSelector = void 0))
  var t2 = j
  Object.defineProperty(e2, 'allInputsSelector', {
    enumerable: true,
    get: function () {
...
;(function (e2) {
  ...
  var t2 = C$1
  Object.defineProperty(e2, 'append', {
    enumerable: true,
    get: function () {
      return t2.append
    },
...
;(function (e2) {
  ...
  var t2 = S$1
  Object.defineProperty(e2, 'blockElements', {
    enumerable: true,
    get: function () {
...
function Ge(e2) {
  var t2 = globalThis.window.getComputedStyle(e2),
    n3 = parseFloat(t2.fontSize),
    r2 = parseFloat(t2.lineHeight) || n3 * 1.2,
    i = parseFloat(t2.paddingTop),
    a2 = parseFloat(t2.borderTopWidth),
    l2 = parseFloat(t2.marginTop),
    u2 = n3 * 0.8,
    d = (r2 - n3) / 2,
    s2 = l2 + a2 + i + d + u2
  return s2
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.calculateBaseline = void 0))
  var t2 = M$1
  Object.defineProperty(e2, 'calculateBaseline', {
    enumerable: true,
    get: function () {
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.isContentEditable = void 0))
  var t2 = N
  Object.defineProperty(e2, 'isContentEditable', {
    enumerable: true,
    get: function () {
...
function Qe(e2) {
  ...
  else t2 = (0, Ye.isContentEditable)(e2)
  return t2
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }), (e2.canSetCaret = void 0))
  var t2 = k$1
  Object.defineProperty(e2, 'canSetCaret', {
    enumerable: true,
    get: function () {
...
function Ve(e2, t2, n3) {
  const r2 = n3.value !== void 0 ? 'value' : 'get',
    i = n3[r2],
    a2 = `#${t2}Cache`
  if (
    ((n3[r2] = function (...l2) {
...
function ue() {
  const e2 = {
    ...
    t2 = Object.keys(e2).find(
      (n3) => globalThis.window.navigator.appVersion.toLowerCase().indexOf(n3) !== -1,
    )
...
const Je = () =>
  typeof globalThis.window < 'u' &&
  globalThis.window.navigator !== null &&
  A$1(globalThis.window.navigator.platform) &&
  (/iP(ad|hone|od)/.test(globalThis.window.navigator.platform) ||
    (globalThis.window.navigator.platform === 'MacIntel' &&
      globalThis.window.navigator.maxTouchPoints > 1))
function xe(e2) {
  const t2 = ue()
  return (
    (e2 = e2
      ...
      .replace(/\+/gi, '+')),
    t2.mac
      ? (e2 = e2.replace(/ctrl|cmd/gi, '⌘').replace(/alt/gi, '⌥'))
      : (e2 = e2.replace(/cmd/gi, 'Ctrl').replace(/windows/gi, 'WIN')),
    e2
  )
}
function et(e2) {
...
function tt2(e2) {
  ...
  ;((t2.style.position = 'absolute'),
    (t2.style.left = '-999px'),
    (t2.style.bottom = '-999px'),
    (t2.innerHTML = e2),
    globalThis.document.body.appendChild(t2))
  const n3 = globalThis.window.getSelection(),
    r2 = globalThis.document.createRange()
  if ((r2.selectNode(t2), n3 === null)) throw new Error('Cannot copy text to clipboard')
  ;(n3.removeAllRanges(),
    n3.addRange(r2),
    globalThis.document.execCommand('copy'),
    globalThis.document.body.removeChild(t2))
}
function nt2(e2, t2, n3) {
  ...
  return (...i) => {
    ...
    ;(globalThis.window.clearTimeout(r2),
      (r2 = globalThis.window.setTimeout(l2, t2)),
      u2 && e2.apply(a2, i))
  }
}
function o(e2) {
...
function O$1(e2, ...t2) {
  ...
  if (g$1(e2) && g$1(n3))
    for (const r2 in n3)
      g$1(n3[r2])
        ? (e2[r2] === void 0 && Object.assign(e2, { [r2]: {} }), O$1(e2[r2], n3[r2]))
        : Object.assign(e2, { [r2]: n3[r2] })
  return O$1(e2, ...t2)
}
...
function ct(e2) {
  ...
  return e2.substring(0, 2) === '//'
    ? globalThis.window.location.protocol + e2
    : globalThis.window.location.origin + e2
}
function dt(e2) {
  return (
    (e2 > 47 && e2 < 58) ||
...
function gt(e2, t2, n3 = void 0) {
  ...
  n3 || (n3 = {})
  const d = function () {
    ;((u2 = n3.leading === false ? 0 : Date.now()),
      (l2 = null),
      (a2 = e2.apply(r2, i)),
      l2 === null && (r2 = i = null))
  }
    ...
    return (
      ...
      f3 <= 0 || f3 > t2
        ? (l2 && (clearTimeout(l2), (l2 = null)),
          ...
          (a2 = e2.apply(r2, i)),
          l2 === null && (r2 = i = null))
        : !l2 && n3.trailing !== false && (l2 = setTimeout(d, f3)),
      a2
    )
  }
}
const mt2 = /* @__PURE__ */ Object.freeze(
...
function _t(e2) {
  var t2
  ;(0, bt2.isString)(e2)
    ? ((t2 = globalThis.document.createElement('div')), (t2.innerHTML = e2))
    : (t2 = e2)
  var n3 = function (r2) {
    return (
      !(0, yt.blockElements)().includes(r2.tagName.toLowerCase()) &&
      Array.from(r2.children).every(n3)
    )
  }
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.containsOnlyInlineElements = void 0))
  var t2 = I
  Object.defineProperty(e2, 'containsOnlyInlineElements', {
    enumerable: true,
    get: function () {
...
function ht2(e2, t2, n3) {
  ...
  } else t2 !== null && i.classList.add(t2)
  for (var l2 in n3) Object.prototype.hasOwnProperty.call(n3, l2) && (i[l2] = n3[l2])
  return i
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }), (e2.make = void 0))
  var t2 = D
  Object.defineProperty(e2, 'make', {
    enumerable: true,
    get: function () {
      return t2.make
    },
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.fragmentToString = void 0))
  var t2 = B$1
  Object.defineProperty(e2, 'fragmentToString', {
    enumerable: true,
    get: function () {
...
function jt(e2) {
  var t2, n3
  return (0, Pt.isNativeInput)(e2)
    ? e2.value.length
    : e2.nodeType === Node.TEXT_NODE
      ? e2.length
      : (n3 = (t2 = e2.textContent) === null || t2 === void 0 ? void 0 : t2.length) !==
            null && n3 !== void 0
        ? n3
        : 0
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.getContentLength = void 0))
  var t2 = H$1
  Object.defineProperty(e2, 'getContentLength', {
    enumerable: true,
    get: function () {
...
var R$1 = {},
  F$1 = {},
  re =
    (b$1 && b$1.__spreadArray) ||
    function (e2, t2, n3) {
      if (n3 || arguments.length === 2)
        for (var r2 = 0, i = t2.length, a2; r2 < i; r2++)
          (a2 || !(r2 in t2)) &&
            (a2 || (a2 = Array.prototype.slice.call(t2, 0, r2)), (a2[r2] = t2[r2]))
...
var Tt = y$1
function de(e2) {
  return (0, Tt.containsOnlyInlineElements)(e2)
    ? [e2]
    : Array.from(e2.children).reduce(function (t2, n3) {
        return re(re([], t2, true), de(n3), true)
      }, [])
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.getDeepestBlockElements = void 0))
  var t2 = F$1
  Object.defineProperty(e2, 'getDeepestBlockElements', {
    enumerable: true,
    get: function () {
...
U.isLineBreakTag = Ct
function Ct(e2) {
  return ['BR', 'WBR'].includes(e2.tagName)
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.isLineBreakTag = void 0))
  var t2 = U
  Object.defineProperty(e2, 'isLineBreakTag', {
    enumerable: true,
    get: function () {
...
;(function (e2) {
  ...
  var t2 = q
  Object.defineProperty(e2, 'isSingleTag', {
    enumerable: true,
    get: function () {
...
function pe(e2, t2) {
  t2 === void 0 && (t2 = false)
  var n3 = t2 ? 'lastChild' : 'firstChild',
    r2 = t2 ? 'previousSibling' : 'nextSibling'
  if (e2.nodeType === Node.ELEMENT_NODE && e2[n3]) {
    var i = e2[n3]
    if ((0, kt.isSingleTag)(i) && !(0, St.isNativeInput)(i) && !(0, Mt.isLineBreakTag)(i))
      if (i[r2]) i = i[r2]
      else if (i.parentNode !== null && i.parentNode[r2]) i = i.parentNode[r2]
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.getDeepestNode = void 0))
  var t2 = W
  Object.defineProperty(e2, 'getDeepestNode', {
    enumerable: true,
    get: function () {
...
var wt = y$1,
  ...
  At = c$1
function $t(e2) {
  return Array.from(e2.querySelectorAll((0, It.allInputsSelector)())).reduce(function (
    t2,
    n3,
  ) {
    return (0, At.isNativeInput)(n3) || (0, wt.containsOnlyInlineElements)(n3)
      ? p(p([], t2, true), [n3], false)
      : p(p([], t2, true), (0, Nt.getDeepestBlockElements)(n3), true)
  }, [])
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }), (e2.findAllInputs = void 0))
  var t2 = z
  Object.defineProperty(e2, 'findAllInputs', {
    enumerable: true,
    get: function () {
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.isCollapsedWhitespaces = void 0))
  var t2 = G
  Object.defineProperty(e2, 'isCollapsedWhitespaces', {
    enumerable: true,
    get: function () {
...
var Dt2 = $
function Ht(e2) {
  return (0, Dt2.isNumber)(e2)
    ? false
    : !!e2 && !!e2.nodeType && e2.nodeType === Node.ELEMENT_NODE
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }), (e2.isElement = void 0))
  var t2 = X
  Object.defineProperty(e2, 'isElement', {
    enumerable: true,
    get: function () {
      return t2.isElement
    },
...
;(function (e2) {
  ...
  var t2 = V
  Object.defineProperty(e2, 'isLeaf', {
    enumerable: true,
    get: function () {
      return t2.isLeaf
    },
...
function zt(e2, t2) {
  var n3 = ''
  return (0, qt.isSingleTag)(e2) && !(0, Ft.isLineBreakTag)(e2)
    ? false
    : ((0, Wt.isElement)(e2) && (0, Ut.isNativeInput)(e2)
        ? (n3 = e2.value)
        : e2.textContent !== null && (n3 = e2.textContent.replace('​', '')),
      t2 !== void 0 && (n3 = n3.replace(new RegExp(t2, 'g'), '')),
      n3.trim().length === 0)
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }), (e2.isNodeEmpty = void 0))
  var t2 = J
  Object.defineProperty(e2, 'isNodeEmpty', {
    enumerable: true,
    get: function () {
...
function Xt(e2, t2) {
  ...
  for (var n3 = [e2]; n3.length > 0; ) {
    var r2 = n3.shift()
    if (r2) {
      if (((e2 = r2), (0, Gt.isLeaf)(e2) && !(0, Kt.isNodeEmpty)(e2, t2))) return false
...
;(function (e2) {
  ...
  var t2 = Y
  Object.defineProperty(e2, 'isEmpty', {
    enumerable: true,
    get: function () {
      return t2.isEmpty
    },
...
var Yt = $
function Qt(e2) {
  return (0, Yt.isNumber)(e2)
    ? false
    : !!e2 && !!e2.nodeType && e2.nodeType === Node.DOCUMENT_FRAGMENT_NODE
}
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }), (e2.isFragment = void 0))
  var t2 = x$1
  Object.defineProperty(e2, 'isFragment', {
    enumerable: true,
    get: function () {
...
;(function (e2) {
  ...
  var t2 = ee
  Object.defineProperty(e2, 'isHTMLString', {
    enumerable: true,
    get: function () {
...
function Jt(e2) {
  var t2 = e2.getBoundingClientRect(),
    n3 = globalThis.window.pageXOffset || globalThis.document.documentElement.scrollLeft,
    r2 = globalThis.window.pageYOffset || globalThis.document.documentElement.scrollTop,
    i = t2.top + r2,
    a2 = t2.left + n3
  return {
    top: i,
...
;(function (e2) {
  ...
  var t2 = te
  Object.defineProperty(e2, 'offset', {
    enumerable: true,
    get: function () {
      return t2.offset
    },
...
;(function (e2) {
  ...
  var t2 = ne
  Object.defineProperty(e2, 'prepend', {
    enumerable: true,
    get: function () {
      return t2.prepend
    },
...
;(function (e2) {
  ;(Object.defineProperty(e2, '__esModule', { value: true }),
    (e2.prepend =
      ...
      e2.isEmpty =
      e2.isElement =
      e2.isContentEditable =
      e2.isCollapsedWhitespaces =
      e2.findAllInputs =
      e2.isNativeInput =
      e2.allInputsSelector =
      e2.getDeepestNode =
      e2.getDeepestBlockElements =
      e2.getContentLength =
      e2.fragmentToString =
      e2.containsOnlyInlineElements =
      e2.canSetCaret =
      e2.calculateBaseline =
      e2.blockElements =
      e2.append =
        void 0))
  var t2 = P
...
var Ee = /* @__PURE__ */ ((e2) => ((e2.Left = 'left'), (e2.Center = 'center'), e2))(
  Ee || {},
)
let m$1 = class m {
  /**
  ...
  constructor({ data: t2, config: n3, api: r2, readOnly: i, block: a2 }) {
    ...
    ;((this.api = r2),
      (this.readOnly = i),
      (this.quotePlaceholder = r2.i18n.t(
        (n3 == null ? void 0 : n3.quotePlaceholder) ?? m.DEFAULT_QUOTE_PLACEHOLDER,
      )),
      (this.captionPlaceholder = r2.i18n.t(
        (n3 == null ? void 0 : n3.captionPlaceholder) ?? m.DEFAULT_CAPTION_PLACEHOLDER,
      )),
      (this.data = {
        text: t2.text || '',
        caption: t2.caption || '',
        alignment: Object.values(Ee).includes(t2.alignment)
          ? t2.alignment
          : ((n3 == null ? void 0 : n3.defaultAlignment) ?? l2),
      }),
      (this.css = {
   ...
   */
  render() {
    const t2 = v$1.make('blockquote', [this.css.baseClass, this.css.wrapper]),
    ...
    return (
      (n3.dataset.placeholder = this.quotePlaceholder),
      (r2.dataset.placeholder = this.captionPlaceholder),
      t2.appendChild(n3),
      t2.appendChild(r2),
      t2
    )
   ...
   */
  save(t2) {
    const n3 = t2.querySelector(`.${this.css.text}`),
      r2 = t2.querySelector(`.${this.css.caption}`)
...
class AbstractMediaTool extends BaseTool {
  ...
  constructor({ api, config, readOnly, data }) {
    ...
    this.nodes = {
      wrapper: make.element('div', [this.api.styles.block, 'image-tool']),
...
${output}
  ...
  function parseKeywords() {
    return (
      ...
      parseKeyword('null', 'null') || // repair Python keywords True, False, None
      parseKeyword('True', 'true') ||
      parseKeyword('False', 'false') ||
...
;(function () {
  ...
  try {
    if (typeof globalThis.document < 'u') {
      ...
      ;((o2.nonce =
        (r2 = globalThis.document.head.querySelector('meta[property=csp-nonce]')) == null
          ? void 0
          : r2.content),
        o2.appendChild(
          globalThis.document.createTextNode(
        ...
        globalThis.document.head.appendChild(o2))
    }
  } catch (e2) {
    console.error('vite-plugin-css-injected-by-js', e2)
  }
...
function c(d, t2, e2 = {}) {
  ...
  for (const i in e2) Object.prototype.hasOwnProperty.call(e2, i) && (o2[i] = e2[i])
  return o2
}
function f2(d) {
...
function k(d, t2) {
  const e2 = d.getBoundingClientRect(),
    { width: o2, height: i, x: n3, y: r2 } = e2,
    { clientX: h2, clientY: l2 } = t2
  return {
    width: o2,
    height: i,
    x: h2 - n3,
...
function C(d, t2 = true) {
  const e2 = globalThis.document.createRange(),
    o2 = globalThis.window.getSelection()
...
class a {
  ...
  render() {
    return (
      (this.wrapper = c('div', a.CSS.popover)),
      this.items.forEach((t2, e2) => {
        const o2 = c('div', a.CSS.item),
  ...
  open() {
    ;(this.items.forEach((t2, e2) => {
      typeof t2.hideIf == 'function' &&
        this.itemEls[e2].classList.toggle(a.CSS.itemHidden, t2.hideIf())
    }),
...
class w {
  ...
  createToolbox() {
    ...
    const e2 = this.createPopover(),
      o2 = this.createToggler()
...
class E {
  ...
  constructor(t2, e2, o2, i) {
    ;((this.readOnly = t2),
      ...
      (this.documentClicked = (n3) => {
        const r2 = n3.target.closest(`.${s.table}`) !== null,
          h2 = n3.target.closest(`.${s.wrapper}`) === null
        ;(r2 || h2) && this.hideToolboxes()
        const u2 = n3.target.closest(`.${s.addRow}`),
          p2 = n3.target.closest(`.${s.addColumn}`)
        u2 && u2.parentNode === this.wrapper
          ? (this.addRow(void 0, true), this.hideToolboxes())
          : p2 &&
            p2.parentNode === this.wrapper &&
            (this.addColumn(void 0, true), this.hideToolboxes())
      }),
  ...
  bindEvents() {
    ;(globalThis.document.addEventListener('click', this.documentClicked),
      this.table.addEventListener(
        'mousemove',
        B(150, (t2) => this.onMouseMoveInTable(t2)),
        { passive: true },
      ),
      (this.table.onkeypress = (t2) => this.onKeyPressListener(t2)),
      this.table.addEventListener('keydown', (t2) => this.onKeyDownListener(t2)),
      this.table.addEventListener('focusin', (t2) => this.focusInTableListener(t2)))
  }
  /**
  ...
  addColumn(t2 = -1, e2 = false) {
    ...
    for (let r2 = 1; r2 <= this.numberOfRows; r2++) {
      ...
      if (
        (t2 > 0 && t2 <= o2
          ? ((h2 = this.getCell(r2, t2)), m2(l2, h2))
          : (h2 = this.getRow(r2).appendChild(l2)),
        r2 === 1)
      ) {
    ...
    ;((n3 = this.config) != null &&
      ...
      i &&
      i.classList.add(s.addColumnDisabled),
  ...
  addRow(t2 = -1, e2 = false) {
    ...
    if (t2 > 0 && t2 <= this.numberOfRows) {
      ...
      o2 = m2(i, l2)
    } else o2 = this.table.appendChild(i)
    ...
    return (
      this.config &&
        ...
        this.numberOfRows >= this.config.maxrows &&
        h2 &&
        h2.classList.add(s.addRowDisabled),
      o2
    )
  }
  /**
  ...
  createTableWrapper() {
    if (
      ((this.wrapper = c('div', s.wrapper)),
      (this.table = c('div', s.table)),
   ...
   */
  computeInitialSize() {
    const t2 = this.data && this.data.content,
      e2 = Array.isArray(t2),
      o2 = e2 ? t2.length : false,
      i = e2 ? t2.length : void 0,
      n3 = o2 ? t2[0].length : void 0,
      r2 = Number.parseInt(this.config && this.config.rows),
      h2 = Number.parseInt(this.config && this.config.cols),
      l2 = !isNaN(r2) && r2 > 0 ? r2 : void 0,
      u2 = !isNaN(h2) && h2 > 0 ? h2 : void 0
    return {
      rows: i || l2 || 2,
      cols: n3 || u2 || 2,
    }
  ...
  resize() {
    ...
    for (let o2 = 0; o2 < t2; o2++) this.addRow()
    for (let o2 = 0; o2 < e2; o2++) this.addColumn()
  }
  /**
  ...
  get numberOfColumns() {
    return this.numberOfRows
      ? this.table.querySelectorAll(`.${s.row}:first-child .${s.cell}`).length
      : 0
  }
  /**
  ...
  updateToolboxesPosition(t2 = this.hoveredRow, e2 = this.hoveredColumn) {
    ;(this.isColumnMenuShowing ||
      (e2 > 0 &&
        e2 <= this.numberOfColumns &&
        this.toolboxColumn.show(() => ({
          left: `calc((100% - var(--cell-size)) / (${this.numberOfColumns} * 2) * (1 + (${e2} - 1) * 2))`,
        }))),
      this.isRowMenuShowing ||
        (t2 > 0 &&
          t2 <= this.numberOfRows &&
          this.toolboxRow.show(() => {
            const o2 = this.getRow(t2),
              { fromTopBorder: i } = g(this.table, o2),
              { height: n3 } = o2.getBoundingClientRect()
            return {
   ...
   */
  getHoveredCell(t2) {
    let e2 = this.hoveredRow,
      o2 = this.hoveredColumn
  ...
  getData() {
    const t2 = []
    for (let e2 = 1; e2 <= this.numberOfRows; e2++) {
      const o2 = this.table.querySelector(`.${s.row}:nth-child(${e2})`),
        i = Array.from(o2.querySelectorAll(`.${s.cell}`))
...
class F {
  ...
  render() {
    return (
      (this.table = new E(this.readOnly, this.api, this.data, this.config)),
      (this.container = c('div', this.api.styles.block)),
  ...
  onPaste(t2) {
    const e2 = t2.detail.data,
      o2 = e2.querySelector(':scope > thead, tr:first-of-type th'),
      n3 = Array.from(e2.querySelectorAll('tr')).map((r2) =>
        Array.from(r2.querySelectorAll('th, td')).map((l2) => l2.innerHTML),
      )
    ;((this.data = {
...
class Embed extends AbstractMediaTool {
  ...
  updatePreview() {
    ...
    this.nodes.preview.innerHTML =
      `<div style="display:block;--aspect-ratio:16/9;background: center / cover no-repeat url('/media/md/` +
      this.data.media +
