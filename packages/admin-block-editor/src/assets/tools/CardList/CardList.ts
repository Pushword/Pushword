...
export default class CardList extends BaseTool {
  ...
  private createHtmlEditableField(
    ...
    if (value) {
      // Legacy titles may be entity-encoded; preserve inline formatting safely.
      editable.innerHTML = DOMPurify.sanitize(he.decode(value), {
        ALLOWED_TAGS: ['a', 'b', 'br', 'em', 'i', 's', 'small', 'span', 'strong', 'sub', 'sup', 'u'],
