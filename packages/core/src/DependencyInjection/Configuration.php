...
final class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder
          ...
          ->defaultTrue()
          ->info('When false, the default page_editorial workflow is not registered and the admin workflow field is hidden.')
          ->end()
          ->booleanNode('require_approval_before_publish')
          ->defaultFalse()
          ->info('When true, a page can only be published (publishedAt) once its workflowState is "approved".')
          ->end()
