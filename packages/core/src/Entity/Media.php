...
class Media implements IdInterface, Taggable, Stringable
{
    ...
    /**
     * True while the filename still tracks the (raw) alt — i.e. it was machine-derived
     ...
     */
    public function isFileNameAutoGenerated(): bool
    {
        if ('' === $this->fileName) {
            return false;
        }
        ...
        return $base === MediaFileName::slugify($this->getAlt(true));
    }
