---
title: 'Upgrade to 1.0.0-rc834: the page scanner reports missing image alts and colliding translation locales, two newsletter contacts can be joined into one, galleries, videos and body images open in the lightbox again, and the database now knows which pages use which media'
