...
**Affects sites using [Quiz](/extension/quiz).** Nothing to do. Set `body_image_sizes` (see rc872) to get the illustrations sized too — the thumbnails improve either way.
