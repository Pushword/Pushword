---
title: 'PHP 8.5 required; PHP files use strict types; optional Rust minification, content analysis and Markdown; admin links restrict URLs; MariaDB connections use read committed isolation'
