...
Editorial **workflow** (draft → in_review → approved) and a **pending-modification** review cycle for [Pushword](https://pushword.piedweb.com) pages.
...
- **Flat overlay** (`{slug}.pending.md`) when [pushword/flat](https://github.com/Pushword/flat) is installed, so every proposed change is tracked by Git.
...
- **pushword/page-workflow** — Editorial workflow & pending modifications. *(this package)*
