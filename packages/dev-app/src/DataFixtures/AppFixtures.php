...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $homepage->mainContent = "# Welcome to Pushword\n\nThis is version 2 with more content.\n\n## Features\n- Fast\n- Flexible";
        ...
        $homepage->setMainImage($media['Demo 2']);
        $homepage->mainContent = $finalContent;
        ...
        $ksPage->mainContent = (string) file_get_contents(__DIR__.'/KitchenSink.md');
        ...
        $quizPage->mainContent = (string) file_get_contents(__DIR__.'/Quiz.md');
        ...
        $redirectionPage->mainContent = 'Location: https://pushword.piedweb.com';
        ...
        $homepageFr->mainContent = 'Ceci est la page d\'accueil en français.';
        ...
        $homepageFrCa->mainContent = 'Ceci est la page d\'accueil en français canadien.';
        ...
        if ('localhost.dev' === $this->apps->getMainHost() && class_exists(Message::class)) {
            ...
            $message->authorName = 'Demo User';
            $message->authorEmail = 'demo@localhost.dev';
            $message->host = 'localhost.dev';
            $message->publishedAt = new DateTime('1 day ago');
            ...
            foreach ($reviewsData['reviews'] as $reviewData) {
                ...
                $review->authorEmail = $reviewData['authorEmail'];
                ...
                $review->publishedAt = new DateTime($reviewData['publishedAt']);
