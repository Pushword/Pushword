 ...
 * @psalm-type PushwordConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["hosts","locale","locales","name","base_url","template","template_dir","entity_can_override_filters","filters","assets","custom_properties","svg_dir"]
 *     public_dir?: scalar|null, // Default: "%kernel.project_dir%/public"
 *     media_dir?: scalar|null, // Dir where files will be uploaded when using admin. // Default: "%kernel.project_dir%/media"
 *     public_media_dir?: scalar|null, // Used to generate browser path. Must be accessible from public_dir. // Default: "media"
 *     database_url?: scalar|null, // Default: "sqlite:///%kernel.project_dir%/var/app.db"
 *     entity_page?: scalar|null, // Default: "Pushword\\Core\\Entity\\Page"
 *     entity_media?: scalar|null, // Default: "Pushword\\Core\\Entity\\Media"
 *     entity_user?: scalar|null, // Default: "Pushword\\Core\\Entity\\User"
 *     locale?: scalar|null, // Default: "%kernel.default_locale%"
 *     locales?: scalar|null, // eg: fr|en // Default: "%kernel.default_locale%"
 *     name?: scalar|null, // Default: "Pushword"
 *     host?: mixed, // Default: "localhost"
 *     hosts?: mixed, // Default: ["%pw.host%"]
 *     base_url?: scalar|null, // Default: "https://%pw.host%"
 *     base_live_url?: scalar|null, // Could be `https://my-multi-host.tld/%pw.host%` - used in twig liveBase() // Default: "https://%pw.host%"
 *     assets?: mixed, // Default: {"vite_stylesheets":[],"vite_javascripts":[],"stylesheets":["bundles/pushwordcore/style.css"],"javascripts":["bundles/pushwordcore/app.js","bundles/pushwordcore/alpine.js"],"favicon":["bundles/pushwordcore/app.js"]}
 *     filters?: mixed, // Default: {"main_content":"showMore,markdown,htmlLinkMultisite,htmlObfuscateLink,mainContentSplitter,extended","name":"twig,date,name,extended","title":"elseH1,twig,date,extended","string":"twig,date,extended"}
 *     entity_can_override_filters?: bool, // Default: true
 *     image_filter_sets?: scalar|null, // Default: {"default":{"quality":90,"filters":{"scaleDown":[1980,1280]},"formats":["original","webp"]},"height_300":{"quality":82,"filters":{"scaleDown":[null,300]},"formats":["webp"]},"thumb":{"quality":80,"filters":{"coverDown":[330,330]},"formats":["webp"]},"xs":{"quality":85,"filters":{"scaleDown":[576]},"formats":["webp"]},"sm":{"quality":85,"filters":{"scaleDown":[768]},"formats":["webp"]},"md":{"quality":85,"filters":{"scaleDown":[992]},"formats":["webp","original"]},"lg":{"quality":85,"filters":{"scaleDown":[1200]},"formats":["webp"]},"xl":{"quality":90,"filters":{"scaleDown":[1600]},"formats":["webp"]}}
 *     image_driver?: "auto"|"imagick"|"gd", // Image driver: auto (imagick if available, else gd), imagick, or gd // Default: "auto"
 *     template?: scalar|null, // Default: "@Pushword"
 *     template_dir?: scalar|null, // Default: "%kernel.project_dir%/templates"
 *     custom_properties?: mixed, // Default: []
 *     apps?: mixed, // Default: [[]]
 *     tailwind_generator?: bool, // Default: true
 *     path_to_bin?: scalar|null, // Default: ""
 *     svg_dir?: mixed, // Default: ["%kernel.project_dir%/templates/icons","%vendor_dir%/fortawesome/font-awesome/free/svgs/solid","%vendor_dir%/fortawesome/font-awesome/svgs/solid","%vendor_dir%/fortawesome/font-awesome/free/svgs/regular","%vendor_dir%/fortawesome/font-awesome/svgs/regular","%vendor_dir%/fortawesome/font-awesome/free/svgs/brands","%vendor_dir%/fortawesome/font-awesome/svgs/brands","%kernel.project_dir%/public/bundles/pushwordcore"]
 * }
 * @psalm-type PushwordAdminConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["admin_page_form_fields","admin_redirection_form_fields","admin_user_form_fields","admin_media_form_fields"]
 *     admin_page_form_fields?: mixed, // Default: [["Pushword\\Admin\\FormField\\TagsField","Pushword\\Admin\\FormField\\PageH1Field","Pushword\\Admin\\FormField\\PageMainContentField"],{"adminPageRevisions":["Pushword\\Admin\\FormField\\PageEditMessageField"],"adminPageStateLabel":["Pushword\\Admin\\FormField\\PagePublishedAtField","Pushword\\Admin\\FormField\\PageMetaRobotsField"],"adminPagePermanlienLabel":["Pushword\\Admin\\FormField\\HostField","Pushword\\Admin\\FormField\\PageSlugField"],"adminPageMainImageLabel":["Pushword\\Admin\\FormField\\PageMainImageField"],"adminPageParentPageLabel":["Pushword\\Admin\\FormField\\PageParentPageField"],"adminPageSearchLabel":{"expand":true,"fields":["Pushword\\Admin\\FormField\\PageTitleField","Pushword\\Admin\\FormField\\PageNameField","Pushword\\Admin\\FormField\\PageSearchExcreptField","Pushword\\Admin\\FormField\\WeightField"]},"adminPageTranslationsLabel":["Pushword\\Admin\\FormField\\PageLocaleField","Pushword\\Admin\\FormField\\PageTranslationsField"],"adminPageCustomPropertiesLabel":{"expand":true,"fields":["Pushword\\Admin\\FormField\\CustomPropertiesField"]}}]
 *     admin_redirection_form_fields?: mixed, // Default: [["Pushword\\Admin\\FormField\\PageH1Field","Pushword\\Admin\\FormField\\PageMainContentField"],{"adminPagePermanlienLabel":["Pushword\\Admin\\FormField\\HostField","Pushword\\Admin\\FormField\\PageSlugField"],"adminPageCustomPropertiesLabel":{"expand":true,"fields":["Pushword\\Admin\\FormField\\CustomPropertiesField"]}}]
 *     admin_user_form_fields?: mixed, // Default: [["Pushword\\Admin\\FormField\\UserEmailField","Pushword\\Admin\\FormField\\UserUsernameField","Pushword\\Admin\\FormField\\UserPasswordField","Pushword\\Admin\\FormField\\CreatedAtField"],{"adminUserLabelSecurity":["Pushword\\Admin\\FormField\\UserRolesField","Pushword\\Admin\\FormField\\UserLocaleField"]}]
 *     admin_media_form_fields?: mixed, // Default: [["Pushword\\Admin\\FormField\\MediaMediaFileField","Pushword\\Admin\\FormField\\MediaNameField","Pushword\\Admin\\FormField\\TagsField","Pushword\\Admin\\FormField\\MediaSlugField"],["Pushword\\Admin\\FormField\\CustomPropertiesField","Pushword\\Admin\\FormField\\MediaNamesField"],[]]
 * }
 * @psalm-type PageUpdateNotifierConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["page_update_notification_from","page_update_notification_to","page_update_notification_interval"]
 *     page_update_notification_from?: scalar|null, // Default: null
 *     page_update_notification_to?: scalar|null, // Default: null
 *     page_update_notification_interval?: scalar|null, // Default: "PT6H"
 * }
 * @psalm-type StaticGeneratorConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["static_generators","static_symlink","static_dir","static_copy"]
 *     static_symlink?: bool, // For github pages, this params is forced to false (need a hard copy). // Default: true
 *     static_generators?: mixed, // Default: ["Pushword\\StaticGenerator\\Generator\\PagesGenerator","Pushword\\StaticGenerator\\Generator\\RobotsGenerator","Pushword\\StaticGenerator\\Generator\\ErrorPageGenerator","Pushword\\StaticGenerator\\Generator\\CopierGenerator","Pushword\\StaticGenerator\\Generator\\MediaGenerator","Pushword\\StaticGenerator\\Generator\\HtaccessGenerator","Pushword\\StaticGenerator\\Generator\\CaddyfileGenerator","Pushword\\StaticGenerator\\Generator\\PagesCompressor"]
 *     static_dir?: scalar|null, // If null or empty, static dir will be %kernel.project_dir%/static/%main_host%/. // Default: "%kernel.project_dir%/static/%main_host%"
 *     static_copy?: mixed, // file or folder in your public dir to copy in static // Default: ["assets","bundles","media"]
 * }
 * @psalm-type PushwordPageScannerConfig = array{
 *     min_interval_between_scan?: scalar|null, // Default: "PT5M"
 *     links_to_ignore?: list<scalar|null>,
 * }
 * @psalm-type PushwordTemplateEditorConfig = array{
 *     disable_creation?: bool, // Default: false
 *     can_be_edited_list?: mixed, // Default: []
 * }
 * @psalm-type PushwordFlatConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["flat_content_dir"]
 *     flat_content_dir?: scalar|null, // Default: "%kernel.project_dir%/content/_host_"
 * }
 * @psalm-type ConversationConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["conversation_notification_email_to","conversation_notification_email_from","conversation_notification_interval","conversation_form","conversation_form_message","conversation_form_multistep_message","conversation_form_ms_message","conversation_form_newsletter","possible_origins"]
 *     conversation_notification_email_to?: scalar|null, // Default: null
 *     conversation_notification_email_from?: scalar|null, // Default: null
 *     conversation_notification_interval?: scalar|null, // DateInterval's format // Default: "P1D"
 *     conversation_form?: mixed, // Default: {"message":"Pushword\\Conversation\\Form\\MessageForm","ms_message":"Pushword\\Conversation\\Form\\MultiStepMessageForm","multistep_message":"Pushword\\Conversation\\Form\\MultiStepMessageForm","newsletter":"Pushword\\Conversation\\Form\\NewsletterForm"}
 *     conversation_form_message?: scalar|null, // Default: "Pushword\\Conversation\\Form\\MessageForm"
 *     conversation_form_multistep_message?: scalar|null, // Default: "Pushword\\Conversation\\Form\\MultiStepMessageForm"
 *     conversation_form_ms_message?: scalar|null, // Default: "Pushword\\Conversation\\Form\\MultiStepMessageForm"
 *     conversation_form_newsletter?: scalar|null, // Default: "Pushword\\Conversation\\Form\\NewsletterForm"
 *     possible_origins?: scalar|null, // Default: null
 *     review_enabled?: bool, // Default: true
 * }
 * @psalm-type PushwordVersionConfig = array<mixed>
 * @psalm-type PushwordAdminBlockEditorConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["admin_block_editor"]
 *     new_page?: bool, // Set false to disable block editor for new page // Default: true
 *     admin_block_editor?: bool, // set false to disable block editor (and get the default Mardown Editor) // Default: true
 * }
 * @psalm-type PushwordAdvancedMainImageConfig = array{
 *     app_fallback_properties?: mixed, // Default: ["advanced_main_image","main_image_formats"]
 *     advanced_main_image?: bool, // Set false to disable extension // Default: true
 *     main_image_formats?: mixed, // Available main image formats (key = translation label, value = numeric value) // Default: {"adminPageMainImageFormatNone":1,"adminPageMainImageFormatNormal":0,"adminPageMainImageFormat13fullscreen":2,"adminPageMainImageFormat34fullscreen":3}
 * }
