...
class DashboardController extends AbstractDashboardController
{
    ...
    {
        // Monaco weighs a few megabytes: admin.js fetches it from this URL, and only
        // on the pages that hold a field it drives.
        $monacoUrl = json_encode(
            $this->versionedAsset('/bundles/pushwordadmin/monaco/app.js'),
