# Manage SVG / Icon with Pushword

Insert icon (svg) with ease in Pushword's content via a twig function.
...
Visit [pushword.piedweb.com](https://pushword.piedweb.com/extension/svg)
